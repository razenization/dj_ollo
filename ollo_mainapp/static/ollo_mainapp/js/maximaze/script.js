                ...
                <h4>${el.league_id !== null ? el.league_id.name : ""}</h4>
                  ...
                  <div class="live-name-and-logo">
                    ...
                    <div class="live-match-info">
                        <span class="live-match-info-title">Match info</span>
                        <span class="score-live" style="width: 20%;">Score</span>
                        <span class="netw" style="width: 20%">Nw</span>
                    </div>
                    <div class="live-match-team">
                        ...
                        <span class="team-nw">${el.radiant_lead}</span>
                    </div>
                    <div class="live-match-team">
    ...
    $.get(
        ...
        (ee)=>{
            ...
            for (let i = 0; i < (ee.length < 10 ? ee.length : 10 ); i++){
                ...
                let spDateMob = ee[i] !== ee[i < 1 ? i-1 : 0] ? `<span class="upcoming-matches-date " >${date.toLocaleString('ru', {day: "numeric"})}.${date.toLocaleString('ru', {month: "2-digit"})}.${date.getFullYear()}</span>` : "";
                $("#upcomingMobi").append(`
